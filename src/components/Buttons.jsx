...
export const Buttons = () => {
  ...
  const DATA = [
    {
      href: 'https://github.com/elvinlab/',
      aria: 'Visit my GitHub profile',
      icon: <GitHub />,
      label: 'GitHub',
    },
    {
      href: 'https://www.linkedin.com/in/elvinlab/',
      aria: 'Visit my LinkedIn profile',
      icon: <LinkedIn />,
      label: 'LinkedIn',
    },
    {
      href: 'https://1drv.ms/u/s!AhsHSg6Zvebbn1mZUvFJr9n6ZW0S?e=GRAvgt',
      aria: 'Visit One Drive to view and download my resume',
      icon: <Resume />,
      label: 'Resume',
    },
    {
      href: 'mailto:elvinlab@outlook.com',
